...
\lineSummary{Developing firmware for enterprise-grade Battery Management System (BMS) in Modern C++ and Python.}
\listBegin
\listItem{Oversaw sub-system as technical lead. Planned tasks and managed team. Mentored junior developers.}
\listItem{Owned delivery of isolated MCU's (STM32G0) complete software stack, from start to finish of SDLC.
